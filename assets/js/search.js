...
function displaySearch(search, searchTerm) {
    ...
    search.forEach((item, idx) => {
        ...
        searchTitleLink.href = urlprefix == "" ? `/${item.ref.replace('.md', '.html')}` : `/${item.ref.replace('.md', '.html')}`;
        ...
        searchTitleLinkNewTab.href = urlprefix == "" ? `/${item.ref.replace('.md', '.html')}` : `/${item.ref.replace('.md', '.html')}`;
