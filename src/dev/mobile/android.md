...
- [the first line of code](#the-first-line-of-code)
- [Chapter 1: Your First Line of Android Code](#chapter-1-your-first-line-of-android-code)
    - [1.1.1 Android System Architecture](#111-android-system-architecture)
    - [proguard-rules.pro](#proguard-rulespro)
    - [AndroidManifest.xml](#androidmanifestxml)
    - [1.3.5 Resources in a Project](#135-resources-in-a-project)
    - [1.3.6 File of build.gradle](#136-file-of-buildgradle)
      - [First look at the build.gradle file at the outer layer as shown below:](#first-look-at-the-buildgradle-file-at-the-outer-layer-as-shown-below)
      - [Next, let us look at the build.gradle under the app directory, code should be the same as follows:](#next-let-us-look-at-the-buildgradle-under-the-app-directory-code-should-be-the-same-as-follows)
    - [1.4.1 Using Android Log Tool](#141-using-android-log-tool)
- [Chapter 2: Explore New Language: A Quick Introduction to \[kotlin\]](#chapter-2-explore-new-language-a-quick-introduction-to-kotlin)
...
- [Chapter 4: Everything About UI Development](#chapter-4-everything-about-ui-development)
- [Chapter 5: Support Phones and Tablets with Fragment](#chapter-5-support-phones-and-tablets-with-fragment)
- [Chapter 6: Broadcasts in Details](#chapter-6-broadcasts-in-details)
- [Chapter 7: Data Persistence](#chapter-7-data-persistence)
- [Chapter 8: Share Data Between Apps with ContentProvider](#chapter-8-share-data-between-apps-with-contentprovider)
- [Chapter 9: Enrich Your App with Multimedia](#chapter-9-enrich-your-app-with-multimedia)
- [Chapter 10: Work on the Background Service](#chapter-10-work-on-the-background-service)
- [Chapter 11: Exploring New World with Network Technologies](#chapter-11-exploring-new-world-with-network-technologies)
- [Chapter 12: Best UI Experience: Material Design in Action](#chapter-12-best-ui-experience-material-design-in-action)
- [Chapter 13: High-Quality Developing Components: Exploring Jetpack](#chapter-13-high-quality-developing-components-exploring-jetpack)
- [Chapter 14: Keep Stepping Up: More Skills You Need to Know](#chapter-14-keep-stepping-up-more-skills-you-need-to-know)
- [Chapter 15: Real Project Practice: Creating a Weather App](#chapter-15-real-project-practice-creating-a-weather-app)
