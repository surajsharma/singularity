;; Globals.wat 
;; Importing alternative versions of the JavaScript function
...
(module
  ...
  (func (export "globaltest")
    ...
    ;; If you wanted to push a local variable called $x onto the stack, 
    ;; you would need to execute the expression (local.get $x)
  )
)
