...
- unterschied = the schism or division or 'separation' (that is somehow) 'under'. /\


- compare with sanskrit/hindi for difference 'antar', only one syllable short of 'antara', sanskrit for 'within'. the under/antar here is phonetically similar for a reason. the split/schism/separation is at once both under and within.
