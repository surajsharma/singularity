...
- pure difference is the essence of difference, it is difference _deferred_ or difference as its own subject. it is that which cannot be perceived by anything except itself and that which perceives nothing except itself. it is difference raised to the nth power. it is negation that negates itself.
