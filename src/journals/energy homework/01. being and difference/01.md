...
- Pure difference exists in dualities ___embuted___, the moment of intention right before it becomes an action, the potential implicit in each circumstance, in other words, cause-implicit (whereas difference itself is cause-explicit). In the moment before mitosis begins and in the moment penultimate to the completion of cell division.
