...
- Among other things intermediate representations act as a fasteners of meaning, the infamous "collapse" of the wave function acting as pressure fermenting the transition when surface tension is fixed by surfactants or nitrogen fixed by roots or lactobascillus. Infact, the superpositioned substance which affords itself such an excellent trial forms one vector of planar judgement. Since judgement is also a duality, the state transition of both nitrogen and the fixing agency via irrespective means happens on more levels than history may record. But not only nitrogen, even alcohol is a judgement unto itself, if only on a molecular level - the exegesis in many fixations and the genesis of many an obsession. Not to say that all state transition is only molecular nor is meaning fixed in every laminar flow, but once more in the localised pressure of the senses it is easy to construe the forest as the trees. Crossing the Delaware, we find some redcoats drunk on eggnog, we take care of business without giving a thought if it was the eggnog in the first place that egged us on, invited us.
