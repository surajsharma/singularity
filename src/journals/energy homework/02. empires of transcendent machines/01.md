...
> `1.1.1.4` _Transcendence_ is the explication of that which inheres in _immanence_ - its antithesis, the achievement of the former implies the attainment of the latter and vice-versa.
...
`1.1.2` The drive towards immanence is also an entelechy, it is the same paragon of unreason that propels Columbus to find the wrong India - the upside down fall of Parsifal.
...
> `1.1.2.2` From this bipolarity extend ravines of jubilant vaunt that lead not yet to exalted production but to the promise of one that is a fiat of both, regardless of where one starts. 
...
`1.2.5` Not to say that almost everything is a machine, but even the word 'almost' seems to tick away as if a gear inside an alarm clock called 'everything'. The machinery of narrative, not the other way around.
