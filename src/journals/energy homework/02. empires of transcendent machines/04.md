...
> `4.3.3.2` Machines can produce each other of course, so can transcendental machines - miraculously, ordinary machines can create the Buddha, a combination of simple machines is an abstraction in `n±1` dimensions.
