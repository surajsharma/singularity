...
>> `4.2.1.5.2` The absolute is thoroughly absolute and thoroughly determined, and any criticism of the absolute is chaotic like an incredulous typo fighting the rest of the manuscript.
...
>`4.2.6.1` These only _appear_ to be between states because a stable state for these machines is a matter of perspective.
...
`4.2.3` Nor is chance a matter of _how_ the machine is fitted into its epistemological framework - a _symbolic-transcendent_ machine such as `ॐ` does not flit amongst modalities of its knowledge or sodalities of its guild.
...
`4.3.1` Image here is not a photograph or painting, not an image of an image, but _the production of productions_, the network of networks, which is eternal return.
...
> `4.3.2.1` The treachery of the image is its partiality, one so well hidden by frames ornate, whether legal, social, or psychological. 
