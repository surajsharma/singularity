...
#### `4.2` Entropy is a protocol, the phase-type distribution of difference _in_ randomness.
...
`4.3.1` Work produces not a photograph, which is an image of an image, but _the production of productions_, the network of networks, which is eternal return.