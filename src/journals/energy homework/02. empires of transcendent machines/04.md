...
> `4.1.2.1` States of errors resolve into a folding upwards of production, into images of ahistoricity, into states of ignorance guaranteed by the protocol in which the error has occurred, mediated by the protocols below and above it such that one man's trash is easily another's treasure making history the moral equivalent of everyone's trash.
...
`4.4.3` The difference between machines ordinary and transcendent is a determination to follow protocol, a drive to produce images of one kind or another, producing images of leisure is as much work as producing images of work.
...
> `4.4.3.7` Unlike the ultimate the penultimate can have an ontology. Like a police or fire truck siren, heard twice on entry and exit, the penultimate is the engine of the particular, the map of whatever can come before or after a thing. Entropy can have a map, but not entelechy - which can at best be labelled as a drive without the driven.  
