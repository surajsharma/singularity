...
`1.3.2` Machines exist in and as a finite field of states and connections, wherein state transitions are relayed inter alia.

> `1.3.2.1` States are simply descriptive data on extant machine, a state is a unit of information broadcasting a machine's conditions, environment, health etc.
...
>> `1.3.2.2.1` Unlike states, a connection can be a machine i.e. a connecting machine such as a bridge, strait, isthmus, or fibrocartilage.
