...
> `2.2.5.3` Objectively, these become the apparatus of cognition composing and decomposing one machine out of and into another, including superstructures like nation state, organization, family, and other "collectives".
...
> `2.3.5.4` State transition is a reification of feedback, not a _process_.  "_The dogma of process leaves room for freedom_", there are no processes, only state transitions ever.
...
>> `2.6.1.5.1` From `2.2.6.1` this primitivity is a function relative to the size of the network under consideration, a triangle is an image for the network that could be a pyramid etc.
