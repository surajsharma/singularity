...
`3.5.1` The opposite of Transcendence is Immanence (1.1.1.4) but most machines are neither attuned towards nor certified by standards of entelechic attainment.

> `3.5.1.1` The vast majority of ill-configured machinery in the network operates at best in a drive _towards_ the lowest common denominator of entropy it can find.

> `3.5.1.2` This linear drive of entropy forms the basis of existant modes of production and consumption variously described as "muddling through" or "satisficing".
...
`3.5.3` Stochastic ergodicity is an interrupted discernment that turns imaginary networks into real and symbolic and vice-versa. 
