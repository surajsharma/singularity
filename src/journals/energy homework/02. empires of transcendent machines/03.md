...
> `3.5.1.4` Transcendent machines are the flagbearers of eternal return for they do not confirm to extant modes of operating, and defy standing instructions of the network by means of immanent interrupts unique to them.
...
`3.6.5` The four symphonic movements thus complete the quad of the network upon which the identity of the machine composes and decomposes.
...
> `3.6.5.3` There is no last movement in the network, no recurring termination into a single movement but a continuum of emergent interactions, making a market an excellent example of a machine that is a network.