...
`3.1.2`  A machine without network (physically disconnected) is unteneable for the same reasons a machine without feedback (or a 'private language') is illogical (see `2.5.1`, `2.5.4`), even fictional apparatus is connected to the humdrum of the real via the symbolic and the imaginary. 
