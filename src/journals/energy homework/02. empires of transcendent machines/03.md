...
> `3.5.2.1` Grounding is in the assignation of jurisdiction, contituency, domain etc. not too dissimilar from the eponymous punishment or servification.
...
> `3.5.2.2` Decentering is the association with a new set of territoriality, while at the same time a _translation_ over a previous set. It is a grounding _elsewhere_.
